...
export function Chartss({ exdata }) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto mt-6 p-4 bg-white/10 backdrop-blur-md rounded-2xl shadow-lg border border-white/20">
      <div className="flex items-center justify-center mb-2 gap-0">
        <PieChart className="text-yellow-400" />
        <h2 className="text-2xl font-bold text-white tracking-wide">Category-wise Expense</h2>
      </div>
